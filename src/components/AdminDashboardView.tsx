        ...
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-lg font-black tracking-tight text-slate-900 dark:text-white">Admin Executive Control Dashboard</h2>
              <span className="px-2.5 py-0.5 text-[10px] font-black bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-500/30 rounded-full uppercase">
                System Admin
              </span>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 font-medium">Real-time institutional oversight across Karur & Coimbatore campuses</p>
          </div>
        </div>

        <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900/90 border border-slate-200 dark:border-white/15 px-3.5 py-1.5 rounded-xl text-xs font-black text-slate-900 dark:text-amber-300 shadow-sm shrink-0">
