...
const COUNSELOR_PROFILES = [
  ...
  },
  {
    id: "dr_soundar",
    shortName: "Dr S...",
    fullName: "Dr. B. Soundararajan (HoD CSBS)",
    department: "Computer Science and Business System",
    campus: "KARUR",
    benchmarkLeads: 2150,
    benchmarkApps: 18,
    matchKeywords: ["csbs", "business"],
  },
  {
    id: "prof_preethi",
    shortName: "Prof P...",
    fullName: "Prof. J. Preethi (HoD AIML)",
    department: "Artificial Intelligence & Machine Learning",
    campus: "COIMBATORE",
    benchmarkLeads: 2840,
    benchmarkApps: 22,
    matchKeywords: ["aiml", "machine learning"],
  },
  {
    id: "dr_kanthaswamy",
    shortName: "Dr K...",
    fullName: "Dr. S. Kanthaswamy (HoD CCE)",
    department: "Computer Communication Engineering",
    campus: "KARUR",
    benchmarkLeads: 1980,
    benchmarkApps: 14,
    matchKeywords: ["cce", "communication"],
  },
  {
    id: "prof_karthik",
    shortName: "Prof M...",
    fullName: "Prof. M. Karthik (HoD AI&DS)",
    department: "Artificial Intelligence & Data Science",
    campus: "KARUR",
    benchmarkLeads: 3120,
    benchmarkApps: 25,
    matchKeywords: ["ai", "data science"],
  },
  {
    id: "prof_anitha",
    shortName: "Prof V...",
    fullName: "Prof. V. Anitha (HoD BME)",
    department: "Biomedical Engineering",
    campus: "KARUR",
    benchmarkLeads: 1650,
    benchmarkApps: 12,
    matchKeywords: ["biomedical", "bme"],
  },
  {
    id: "prof_divya",
    shortName: "Prof S...",
    fullName: "Prof. S. Divya (HoD Chemical)",
    department: "Chemical Engineering",
    campus: "KARUR",
    benchmarkLeads: 1420,
    benchmarkApps: 8,
    matchKeywords: ["chemical"],
  },
  {
    id: "dr_manikandan",
    shortName: "Dr A...",
    fullName: "Dr. A. Manikandan (HoD Aeronautical)",
    department: "Aeronautical Engineering",
    campus: "COIMBATORE",
    benchmarkLeads: 2240,
    benchmarkApps: 16,
    matchKeywords: ["aero", "aeronautical"],
  },
  {
    id: "prof_priya",
    shortName: "Prof R...",
    fullName: "Prof. R. Priya (HoD Biotechnology)",
    department: "Biotechnology",
    campus: "KARUR",
    benchmarkLeads: 1780,
    benchmarkApps: 11,
    matchKeywords: ["biotech", "biotechnology"],
  },
  {
    id: "dr_suresh",
    shortName: "Dr K...",
    fullName: "Dr. K. Suresh (HoD Data Science)",
    department: "Data Science",
    campus: "KARUR",
    benchmarkLeads: 2360,
    benchmarkApps: 19,
    matchKeywords: ["data science", "analytics"],
  },
];
